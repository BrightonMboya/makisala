  ...
  const initialData = useMemo(() => {
    ...
    if (proposal) {
      ...
      data = {
        ...
        vehicleCount: (proposal as any).vehicleCount ?? 1,
        guideId: (proposal as any).guideId ?? null,
        ...
        days: (proposal.days || []).map((day: any) => ({
          ...
          dayKind: day.dayKind || 'touring',
          isTransit: !!day.isTransit,
          mealCostId: day.mealCostId ?? null,
          ...
          transfer: day.transportation?.[0]
            ? {
                ...
                flightRateId: day.transportation[0].flightRateId ?? null,
              }
            : null,
        })),
      };
