...
**File**: `apps/ratiba/src/app/itineraries/actions.ts`
...
**File**: `apps/ratiba/src/lib/onboarding.ts`
...
**File**: `apps/ratiba/src/app/(dashboard)/_components/onboarding.tsx`
...
**File**: `apps/ratiba/src/app/(dashboard)/dashboard/page.tsx`
...
**Note**: Full tour creation UI is in `apps/makisala/src/app/cms/tour-builder/` - this could be adapted for ratiba later.
...
| `apps/ratiba/src/app/itineraries/actions.ts` | Filter tours by org + shared |
| `apps/ratiba/src/lib/onboarding.ts` | NEW: Onboarding status checker |
| `apps/ratiba/src/app/(dashboard)/_components/onboarding.tsx` | NEW: Onboarding UI component |
| `apps/ratiba/src/app/(dashboard)/dashboard/page.tsx` | Integrate onboarding check |
