...
import { BuilderProvider, useBuilder, type TravelerGroup } from '@/components/itinerary-builder/builder-context'
...
function Header() {
    ...
    return (
        <header className="fixed top-0 z-50 w-full bg-white/80 backdrop-blur-md border-b border-stone-200">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col">
                        <div className="flex items-center gap-2 font-serif font-bold text-stone-900">
                            ...
                            <span className="text-base font-medium text-stone-600">{tourTitle || 'New Tour Request'}</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-6">
                    ...
                    <Popover>
                        <PopoverTrigger asChild>
                            <Button variant="ghost" className="gap-2 text-stone-600 hover:bg-stone-50 hover:text-stone-900">
                                <Users className="h-4 w-4" />
                                <span className="hidden sm:inline font-medium">{totalTravelers} Travelers</span>
                            </Button>
                        </PopoverTrigger>
                    ...
                    <Popover>
                        <PopoverTrigger asChild>
                            <Button variant="ghost" className="gap-2 text-stone-600 hover:bg-stone-50 hover:text-stone-900">
                                ...
                                <span className="hidden sm:inline font-medium">{tourType}</span>
                            </Button>
                        </PopoverTrigger>
                    ...
                    <div className="flex items-center gap-2">
                        <Button variant="outline" size="sm" className="text-stone-600 border-stone-200 hover:bg-stone-50 hover:text-stone-900">
                            Save Draft
                        </Button>
                        <Button size="sm" className="bg-green-700 hover:bg-green-800 shadow-sm text-white border-transparent">
                            Publish Proposal
                        </Button>
                    </div>
                </div>
                    ...
                    {steps.map((step, index) => {
                        ...
                        return (
                            <div key={step.id} className="flex items-center">
                                <Link
                                    href={`/new/${id}/${step.id}`}
                                    className={`flex items-center gap-2 px-8 py-3 text-sm font-medium transition-colors border-b-2 ${
                                        isActive
