...
import { getToursList, getAllProposals } from './actions';
      ...
      try {
        ...
        const transformedRequests: RequestItem[] = proposals.map((proposal) => {
          ...
          const startDate = proposal.startDate
            ...
            : 'TBD';
          const received = proposal.createdAt
          ...
          // Determine status - map proposal status to request status
          let status: 'new' | 'working' | 'draft' | 'shared' = 'new';
      ...
      <div className="w-64 border-r border-stone-200 bg-white">
            ...
            <DialogContent className="max-h-[90vh] max-w-2xl overflow-y-auto">
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 py-4">
                  {/* Client Information */}
                  <div>
                    <h3 className="mb-4 border-b pb-2 text-sm font-bold text-stone-900">
                      Client Information
                    </h3>
        ...
        <nav className="mt-6 space-y-1 px-3">
          ...
          <div className="pt-4 pb-2">
            <div className="px-3 text-xs font-semibold tracking-wider text-stone-500 uppercase">
              Folders
            </div>
          </div>
          <SidebarItem
          ...
          <SidebarItem
            ...
            count={0}
          />
          <SidebarItem icon={<Folder className="h-4 w-4" />} label="Archived" count={0} />
        </nav>
      </div>
      ...
      <div className="flex-1 overflow-auto bg-stone-50/50">
          ...
          <div className="flex items-center gap-4">
            <div className="relative w-64">
              ...
              <Input
                ...
                className="border-stone-200 bg-stone-50 pl-9 transition-colors focus:bg-white"
              />
            </div>
        ...
        <div className="mx-auto max-w-7xl p-8">
          <div className="mb-6 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2 rounded-lg border border-stone-100 bg-white p-1 shadow-sm">
                <Button variant="ghost" size="sm" className="bg-stone-100 text-stone-900 shadow-sm">
                  All
                </Button>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="space-y-1">
                      <div className="flex items-center gap-3">
                        <h3 className="font-serif text-lg font-bold text-stone-900 transition-colors group-hover:text-green-800">
                          {req.client}
                        </h3>
                      ...
                      <div className="flex items-center gap-4 text-sm text-stone-600">
                        <span className="flex items-center gap-1.5">{req.country}</span>
