...
export function DayTable({
    ...
    const handleDuplicateDay = (dayId: string) => {
        ...
        const newDay = {
            ...
            activities: dayToDuplicate.activities.map(a => ({...a, id: Math.random().toString(36).substr(2, 9)}))
        }
        ...
        >
            ...
            <div className="col-span-1 flex gap-2">
                ...
                <div>
                    ...
                    <div className="text-xs text-stone-500 whitespace-nowrap">{day.date}</div>
                </div>
            </div>
                ...
                {day.activities.length === 0 ? (
                    ...
                    <div className="space-y-2">
                        {day.activities.map((activity, idx) => (
                            ...
                            >
                                <span className="font-medium underline decoration-stone-300 underline-offset-2 text-stone-700">
                                    {activity.name}
                                </span>
                                <button 
