...
export default function TourHero({ imageUrl, title, price, days, country }: TourHeroProps) {
    return (
            ...
            <div className="relative flex h-full items-end pb-16">
                <div className="container mx-auto px-4 md:px-6">
                    <div className="animate-fade-in-up max-w-4xl">
                        ...
                        <h1 className="font-heading text-3xl leading-tight font-bold text-white drop-shadow-lg md:text-5xl lg:text-6xl">
                            {title}
                        </h1>
                    </div>
                </div>
