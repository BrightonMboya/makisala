...
import { Eye, FileText, HelpCircle, ImageIcon, Plus, Trash2 } from 'lucide-react'
import { Badge } from '@repo/ui/badge'
import { type HandleInputChange } from '../page'
import type { IPage as PageData } from '@repo/db'
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-sm text-gray-500">
                                URL: /safari/
                                {pageData.page_type === 'blog' ? 'blog' : 'pages'}/{pageData.slug}
                            </p>
                        </div>
                        ...
                        <div>
                            <Label htmlFor="featured-image" className="flex items-center space-x-2">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="prose prose-sm max-w-none">
                            ...
                            {pageData.title && (
                                <h1 className="mb-4 text-2xl font-bold">{pageData.title}</h1>
                            )}
                            {pageData.excerpt && (
                                <p className="mb-6 text-gray-600 italic">{pageData.excerpt}</p>
                            )}
                            <Suspense>
