...
export default function Page() {
    ...
    return (
        <main className="min-h-screen">
                    ...
                    {safaris.map((safari, index) => (
                        <Link
                            ...
                            className={cn(
                                ...
                                index < 2
                                    ? 'h-[300px] md:col-span-2 md:h-[400px]'
                                    : 'h-[300px] md:col-span-1'
                            )}
                        >
                            <Image
            ...
            <section className="py-12">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <p className="mb-12 max-w-2xl text-lg text-gray-600">
                        We don't just book trips; we craft unforgettable experiences rooted in local
                        expertise and sustainable travel.
                    </p>
            ...
            <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
                <h2 className="mb-4 text-5xl font-bold text-gray-900">Popular National Parks</h2>
                <p className="mb-8 text-gray-600">Explore the best of Tanzania's wilderness</p>

                <div className="scrollbar-hide flex w-full snap-x gap-6 overflow-x-auto pb-6">
                    {featured_national_parks.map((destination, index) => (
                        <Link
                            href={destination.page_url}
                            key={index}
                            className="group relative aspect-[4/3] min-w-[280px] flex-none snap-start overflow-hidden rounded-xl sm:min-w-[320px]"
                        >
                            <Image
            ...
            <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
                <div className="mb-8 flex items-center">
                    <div>
                        <h2 className="text-5xl font-bold text-gray-900">Featured itineraries</h2>
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid gap-8 md:grid-cols-3">
                        {reviews.slice(0, 3).map((review: any, index: number) => (
                            <div
                                key={index}
                                className="flex h-full flex-col rounded-xl bg-gray-50 p-8 shadow-sm"
                            >
                                ...
                                <p className="mb-6 line-clamp-4 flex-grow text-gray-700">
                                    "{review.text}"
                                </p>
