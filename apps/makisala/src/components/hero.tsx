...
import { CalendarIcon, Check, MapPin, Search, Users } from 'lucide-react'
    ...
    return (
        <section className="relative flex w-full flex-col items-center justify-center bg-white pt-20 pb-20 md:pt-32 md:pb-20">
            <div className="relative z-10 flex w-full max-w-5xl flex-col items-center px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex w-full flex-col items-center gap-2 rounded-3xl border border-gray-200 bg-white p-2 shadow-[0_2px_16px_rgba(0,0,0,0.12)] md:h-20 md:flex-row md:gap-0">
                    {/* Destination Input */}
                        ...
                        <Popover open={openDestination} onOpenChange={setOpenDestination}>
                            <PopoverTrigger asChild>
                                <Button
                                    ...
                                    className="h-14 w-full justify-start rounded-2xl border-none px-6 text-left font-normal hover:bg-gray-100 md:h-16"
                                >
                                    <MapPin className="mr-3 h-5 w-5 shrink-0 text-gray-900" />
                                    <div className="flex w-full flex-col items-start truncate">
                                        ...
                                        <span
                                            className={cn(
                                                ...
                                                !destination && 'font-normal text-gray-500'
                                            )}
                                        >
                    ...
                    {/* Divider */}
                    <div className="mx-1 hidden h-10 w-px bg-gray-200 md:block" />
                        ...
                        <Popover open={openDate} onOpenChange={setOpenDate}>
                            <PopoverTrigger asChild>
                                <Button
                                    variant="ghost"
                                    className={cn(
                                        'h-14 w-full justify-start rounded-2xl border-none px-6 text-left font-normal hover:bg-gray-100 md:h-16'
                                    )}
                                >
                                    <CalendarIcon className="mr-3 h-5 w-5 shrink-0 text-gray-900" />
                                    <div className="flex w-full flex-col items-start">
                                        ...
                                        <span
                                            className={cn(
                                                ...
                                                !date && 'font-normal text-gray-500'
                                            )}
                                        >
                        ...
                        <Popover>
                            <PopoverTrigger asChild>
                                <Button
                                    ...
                                    className="h-14 w-full justify-start rounded-2xl border-none px-6 text-left font-normal hover:bg-gray-100 md:h-16"
                                >
                                    <Users className="mr-3 h-5 w-5 shrink-0 text-gray-900" />
                                    <div className="flex w-full flex-col items-start">
                                        <span className="text-xs font-bold tracking-wider text-gray-900 uppercase">
                                            Travellers
                                        </span>
                            ...
                            <PopoverContent className="w-64 p-4" align="start">
                                <div className="flex items-center justify-between">
                                    <span className="text-sm font-medium">Adults (18+ years)</span>
                    ...
                    {/* Search Button */}
                    <div className="w-full p-1 md:w-auto">
                        <Button
                            className="bg-primary hover:bg-primary/80 h-14 w-full rounded-2xl text-white shadow-md transition-all hover:scale-105 md:aspect-square md:h-16 md:w-auto md:rounded-full"
                            onClick={handleSearch}
                        >
                            <Search className="h-6 w-6" />
                            <span className="ml-2 font-bold md:hidden">Search</span>
                        </Button>
                    </div>
                </div>
                ...
                <div className="mt-8 flex flex-col items-center justify-center gap-2 text-sm font-medium text-gray-600 sm:flex-row sm:gap-6">
                    <div className="flex items-center gap-1.5">
                        <div className="flex text-yellow-500">
                            {[...Array(5)].map((_, i) => (
                                <Search key={i} className="hidden h-4 w-4 fill-current" /> // Dummy to keep imports if needed, but we need Star
                            ))}
                            <svg
