...
export async function generateMetadata({ params }: IParams): Promise<Metadata> {
    try {
        ...
        return {
            ...
            description:
                destinationOverview.meta_description ||
                destinationOverview.excerpt,
            keywords: destinationOverview.meta_keywords,
            openGraph: {
                title:
                    destinationOverview.meta_title || destinationOverview.title,
                description:
                    destinationOverview.meta_description! ||
                    destinationOverview.excerpt!,
    ...
    return (
        <main className="">
            ...
            >
                {JSON.stringify([
                    ...
                    destinationOverview.faqs &&
                        FAQSchema({ faqs: destinationOverview.faqs }),
                ])}
            </Script>
            ...
            <section className="container mx-auto px-4 py-12 lg:px-8">
                ...
                {destinationOverview.faqs && (
                    <FAQ faqs={destinationOverview.faqs} />
                )}
            </section>
        </main>
    )
