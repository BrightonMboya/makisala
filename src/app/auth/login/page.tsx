...
export default function Page() {
    return (
        <div
            className="container relative flex h-screen items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:space-x-10 ">
            ...
            <div className="grid w-full grid-cols-1 md:grid-cols-3">
                <div className="col-span-1 flex items-center justify-center md:col-span-2">
                    <div
                        className="w-full max-w-md overflow-hidden border-y border-gray-200 sm:rounded-2xl sm:border sm:shadow-xl">
                        <div
                            ...
                            <p className="text-sm text-gray-500">
                                Login to edit Makisala Content
                            </p>
                        </div>
