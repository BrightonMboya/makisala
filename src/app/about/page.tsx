                    ...
                    <div className="grid items-center gap-12 md:grid-cols-2">
                        <div>
                            ...
                            <div className="text-muted-foreground space-y-4">
                                <p>
                                    Makisala was born from a deep love for
                                    travel and a desire to share the raw beauty
                                    of East Africa with the world. What began as
                                    a local initiative has grown into a trusted
                                    safari company, helping travelers from all
                                    corners of the globe experience Africa with
                                    depth and authenticity.
                                </p>
                                <p>
                                    We don’t just plan trips, we craft
                                    meaningful journeys that immerse you in the
                                    land, people, and wildlife that make Africa
                                    unlike anywhere else. Over the years, our
                                    purpose has stayed the same: create
                                    experiences that feel personal, impactful,
                                    and unforgettable.
                                </p>
                                ...
                                <p>
                                    ...
                                    one of the leading safari platforms, where
                                    travelers explore and book authentic East
                                    African experiences.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="mb-12 text-center">
                        ...
                        <p className="text-muted-foreground mx-auto max-w-2xl">
                            Our core values guide every decision we make and
                            every journey we craft for our travelers.
                        </p>
                    </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="grid items-center gap-12 md:grid-cols-2">
                        ...
                        <div className="order-1 md:order-2">
                            ...
                            <div className="text-muted-foreground space-y-4">
                                <p>
                                    At Makisala, we believe travel should go
                                    beyond sightseeing. It should change how you
                                    see the world. Our mission is to connect
                                    cultures, spark curiosity, and foster
                                    respect for nature and people.
                                </p>
                                <p>
                                    Every safari we plan supports local guides,
                                    responsible tourism, and conservation
                                    efforts ensuring that the Africa you fall in
