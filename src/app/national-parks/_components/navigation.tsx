...
export function NavigationSidebar({park_name}: { park_name: string }) {
    ...
    const items = [
        ...
        {name: "Wildlife", href: `/national-parks/${park_name}/wildlife`, active: pathname.endsWith('wildlife')},
        {
            name: "Malaria & Safety",
        ...
        {name: "Climate", href: `/national-parks/${park_name}/climate`, active: pathname.endsWith('climate')},
    ]
                        ...
                        {items.map((item, index) => (
                            <a
                                ...
                                className={cn(
                                    ...
                                    item.active ? "bg-primary text-primary-foreground font-medium" : "text-muted-foreground",
                                )}
