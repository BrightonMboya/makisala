...
export async function generateMetadata({ params }: IParams): Promise<Metadata> {
    ...
    const { page } = await getNPInfo(park, 'weather_page_id')
...
export default async function page({ params }: IParams) {
    const { park } = await params
    const { park: np, page, tours } = await getNPInfo(park, 'weather_page_id')
                    ...
                    BreadcrumbSchema({
                        breadcrumbs: [
                            ...
                            },
                            {
                                ...
                                url: `${BASE_URL}/national-parks/${np.name}/climate`,
                            },
                        ],
                    }),
