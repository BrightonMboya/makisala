                    ...
                    <div className="max-w-4xl mx-auto px-6">
                        <div className="prose prose-lg max-w-none text-lg text-muted-foreground leading-relaxed ">
                            ...
                            <p className="pt-3">You're waking up to the soft rustle of the wind through the trees, your
                                partner still wrapped in sleep beside you. Outside, the sky is turning the softest shade
                                of
                                pink. You sip coffee in silence, watching elephants move through the morning mist, no
                                noise, no rush, just presence.</p>
                            <p className="pt-3">
                                Later, it's just the two of you, alone in the wild, chasing golden light on an evening
                                game
                                drive. And when night falls? You're wrapped in a blanket by the fire, stars spilling
                                across
                            ...
                            <p className="pt-3">
                                Whether you're looking to unwind, reignite, or simply celebrate your love, the wild
                                offers a
                ...
                <section className="pb-20">
                    <div className="max-w-4xl mx-auto px-6">
                        ...
                        <div className="prose prose-lg max-w-none">
                            ...
                            <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                                Whether you're celebrating an anniversary, popping the question, or just need a break
                                from
                                the noise, there’s a perfect safari waiting for you. Some couples even bring letters to
                                read to each other by the campfire. Others don’t say a word, they just sit in stillness
                                and
                                soak it all in.
                            </p>
                            <p className="text-lg text-muted-foreground leading-relaxed">
                                Africa offers countless picturesque honeymoon settings and we know just where to take
                                you to
                                guarantee incredible experiences. There is a broad range of honeymoon itineraries on
                                offer,
