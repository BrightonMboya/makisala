                ...
                <section className=" ">
                    <div className="max-w-4xl mx-auto px-6">
                        <div className="prose prose-lg max-w-none text-lg text-muted-foreground leading-relaxed ">
                            <h3 className="text-4xl font-bold pt-10 text-black">
                            ...
                            <p className="pt-3">
                                ...
                                sitting around the fire telling old stories. You're all seeing the
                                same moment at the same time, and actually feeling it.
                            </p>
                            ...
                            <p className="pt-3">
                                And whether you're bringing young kids, grown-up children, or your
                                own parents, we tailor everything around your pace and comfort.
                            </p>
