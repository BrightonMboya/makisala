                    ...
                    <div className="mx-auto max-w-4xl px-6">
                        <div className="prose prose-lg text-muted-foreground max-w-none text-lg leading-relaxed">
                            <h3 className="pt-10 text-4xl font-bold text-black">
                                Real time together. The bonding that your family
                                needs.
                            </h3>
                            <p className="pt-3">
                                Maybe it’s been a while since you all travelled
                                as a family. Careers, distance, life, it gets in
                                the way. And now, you&#39;re thinking: we need
                                something different. Not just a beach resort,
                                not another cruise. Something that actually
                                means something.
                            </p>
                            <p className="pt-3">
                                A safari gives you that space. It brings people
                                together in a way few holidays can.
                            </p>
                            <p className="pt-3">
                                It’s the kind of trip where you’re all present.
                                No distractions, no packed schedules. Just
                                shared experiences, the kind you talk about
                                years later. You’re watching elephants cross the
                                river. You’re sitting around the fire telling
                                old stories. You&#39;re all seeing the same
                                moment at the same time, and actually feeling
                                it.
                            </p>
                            ...
                            <p className="pt-3">
                                And whether you&#39;re bringing young kids,
                                grown-up children, or your own parents, we
                                tailor everything around your pace and comfort.
                            </p>
                            <ul className="list-disc pl-10">
                                <li>
                                    Private guides who move with your rhythm
                                </li>
                                <li>
                                    Lodges with space to breathe and connect
                                </li>
                                <li>Game drives that turn into life lessons</li>
                                <li>
                                    Evenings with no agenda, just good food and
                                    better company
                                </li>
                            </ul>
                            <p className="pt-3">
                                This isn’t about ticking off sights. It’s about
                                getting the kind of time with your family that’s
                                hard to find these days.
                            </p>

                            <p className="pt-3">
                                So if you’ve been waiting for the right moment
                                to bring everyone together, this is it.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section className="from-primary/10 to-secondary/10 bg-gradient-to-r py-20">
                    <div className="mx-auto max-w-4xl px-6 text-center">
                        ...
                        <p className="text-muted-foreground mb-8 text-xl">
                            Let us help you plan a safari that’s all about
                            connection, adventure, and time well spent.
                        </p>
