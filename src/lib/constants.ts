...
export const safaris = [
    ...
    // },
    {
        ...
        image: 'https://images.unsplash.com/photo-1673667616969-8466c862b9ca?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8aG9uZXltb29uJTIwc2FmYXJpfGVufDB8fDB8fHww',
    },
]
...
export const destinations = {
    top_destinations: [
        ...
        {
            name: 'Zanzibar',
            description: 'Conclude your Tanzania Safari here',
            page_url: '/safaris/zanzibar',
        },
    ],
    east_africa: [
        {
